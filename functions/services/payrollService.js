...
<body>
  <div class="header">
    <div class="logo">InteriMed Staff Request</div>
  ...
  <div class="footer">
    <p>This request was generated by InteriMed Healthcare Staffing Platform.</p>
    ...
    async (event) => {
        ...
        try {
            ...
            await mailTransporter.sendMail({
                ...
                subject: `[InteriMed] Staff Request ${requestId} - ${data.pharmacyProfile?.companyName || 'Unknown'}`,
                text: `
New staffing request has been submitted via InteriMed.
...
---
InteriMed Healthcare Staffing Platform
