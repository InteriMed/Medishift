      ...
      >
        ...
        return (
          <div
            ...
            className={`flex flex-col items-center justify-center cursor-pointer transition-colors hover:bg-muted/50 pb-2 ${dragOverIndex === index ? 'drag-over bg-primary/20' : ''}`}
            style={{
          ...
          >
            <div className={cn(
              ...
              nightView && index % 2 === 1 ? "text-red-500 font-semibold" : "text-muted-foreground"
            )} style={{ fontSize: 'var(--font-size-small)', fontWeight: 'var(--font-weight-medium)' }}>
              {shortDays[dayIndex]}
            </div>
            <div
              className={cn(
                ...
                isToday
                  ...
                  : isCurrentDay
                    ...
                    : nightView && index % 2 === 1 ? 'text-red-500' : 'text-foreground'
              )}
