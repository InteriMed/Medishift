    ...
    return (
        <div className="flex flex-col h-full bg-background overflow-y-auto">
            <div className="sticky top-0 z-20 w-full bg-background/80 backdrop-blur-xl border-b border-border">
                <div className="w-full h-16 flex items-center px-4 relative justify-between max-w-[1400px] mx-auto">
                    <button
                        onClick={onBack}
            ...
            <main className="w-full max-w-[1400px] mx-auto p-4 md:p-8 space-y-8 flex-1">
