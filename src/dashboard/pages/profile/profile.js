...
const Profile = () => {
    ...
    const handleCancelClick = () => {
        const shouldShowmodal = handleCancelChanges();
        if (shouldShowmodal) {
        ...
        <>
            <div className={cn(
                    ...
                    actions={
                        <div className="flex justify-between flex-nowrap gap-3 w-full">
                            <div className="flex gap-3">
                                <Button
                                    variant="secondary"
                                    onClick={handleCloseAutoFillmodal}
                ...
                <modal
                    ...
                    messageType="warning"
                    actions={<><Button onClick={() => setShowCancelmodal(false)} variant="secondary">{t('common:no')}</Button><Button onClick={handleConfirmCancel} variant="warning">{t('common:yesDiscard')}</Button></>}
                ><p>{t('validation:discardChangesWarning')}</p></modal>
            </div>
