...
import { FiSearch, FiFileText, FiInbox, FiX, FiSliders, FiPlus } from 'react-icons/fi';
                ...
                <div className="max-w-[1400px] mx-auto w-full p-6">
                    <div className={cn(
                            ...
                            <div className={cn(
                                ...
                                {!hasAnyContracts ? (
                                    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
                                        ...
                                        <h2 className="text-lg font-semibold mb-2" style={{ color: 'var(--text-color)', fontFamily: 'var(--font-family-text, Roboto, sans-serif)' }}>{t('contracts:noContracts')}</h2>
                                        <p className="mb-4" style={{ color: 'var(--text-light-color)', fontFamily: 'var(--font-family-text, Roboto, sans-serif)' }}>{t('contracts:startApplying')}</p>
                                        <button
                                            onClick={() => {
                                                const workspaceId = getWorkspaceIdForUrl(selectedWorkspace);
                                                const marketplacePath = buildDashboardUrl('/marketplace', workspaceId);
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
                                        ...
                                        <h2 className="text-lg font-semibold mb-2" style={{ color: 'var(--text-color)', fontFamily: 'var(--font-family-text, Roboto, sans-serif)' }}>{t('contracts:noMatches')}</h2>
                        ...
                        <div className={cn(
                            ...
                            )} style={{ border: '1px solid hsl(var(--border))', borderRadius: '0.75rem' }}>
                                {selectedContract ? (
                                    <>
                                        {isPdfView ? (
                                    ...
                                    <div className="w-full h-full flex flex-col items-center justify-center p-8 text-center">
                                        ...
                                        <h2 className="text-lg font-semibold mb-2" style={{ color: 'var(--text-color)', fontFamily: 'var(--font-family-text, Roboto, sans-serif)' }}>{t('contracts:selectContract')}</h2>
