      ...
      <div style={{
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <a
            ...
            className="p-4 bg-yellow-1/50 hover:bg-yellow-1 rounded-lg border border-yellow-3 transition-colors"
          >
            <h3 className="font-medium mb-1">
              {t('admin:dashboard.debugTool', 'Debug: Account Creation')}
            </h3>
            <p className="text-sm text-muted-foreground">
              {t('admin:dashboard.debugToolDesc', 'Create professional/facility accounts bypassing verification')}
            </p>
          </a>
        </div>
      </div>
