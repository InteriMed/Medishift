...
export const tutorialSteps = {
  ...
  dashboard: [
    {
      ...
      replicateSelector: '[data-tutorial="header-right-actions"]',
      targetArea: 'header',
  ...
  // Facility Profile tabs tutorial sequence - Guides through facility tabs in order
  facilityProfileTabs: [
    {
      id: 'facility-core-details-tab',
      title: 'Step 1: Facility Core Details',
      content: 'Start by filling out your facility information like name, type, address, and contact details. You can upload documents using the Auto Fill button to speed up the process, or fill in the information manually.',
      targetSelector: '[data-tutorial="profile-upload-button"]',
      targetArea: 'content',
      highlightTab: 'facilityCoreDetails',
      highlightUploadButton: true,
      navigationPath: '/dashboard/profile/facilityCoreDetails',
      requiresInteraction: true,
      customButtons: [
        {
          text: 'I understood',
    ...
    },
    {
      ...
      title: 'Step 2: Legal & Billing Information',
      content: 'Next, add your legal company details, billing information, and payment setup. You can use the Auto Fill button to speed up the process, or fill in the information manually. Complete this section to continue to the next step.',
      targetSelector: 'button[data-tab="facilityLegalBilling"]',
      targetArea: 'content',
      highlightTab: 'facilityLegalBilling',
      highlightUploadButton: true,
      navigationPath: '/dashboard/profile/facilityLegalBilling',
      requiresInteraction: true,
      customButtons: [
        {
          text: 'I understood',
    ...
    {
      id: 'facility-documents-tab',
      title: 'Step 3: Document Uploads',
      content: 'Finally, upload your facility documents such as licenses, certificates, and identification. You can use the Auto Fill button if you have documents ready, or upload them manually. This is the last step!',
      targetSelector: 'button[data-tab="facilityDocuments"]',
      targetArea: 'content',
      highlightTab: 'facilityDocuments',
      highlightUploadButton: true,
      navigationPath: '/dashboard/profile/facilityDocuments',
      requiresInteraction: true,
      customButtons: [
        {
          text: 'I understood',
    ...
    },
    {
      ...
      title: 'Profile Complete!',
      content: 'Congratulations! Your facility profile is now complete. You have access to all platform features. Let\'s continue to the next section.',
      targetSelector: '.profileContainer',
      targetArea: 'content',
      tooltipPosition: { top: '150px', left: '50%' },
      navigationPath: '/dashboard/profile/settings',
