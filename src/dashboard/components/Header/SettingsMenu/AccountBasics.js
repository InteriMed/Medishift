...
const AccountBasics = ({
  ...
  const confirmDeleteAccount = () => {
    ...
    setIsReauthDialogOpen(true); // Always require re-auth for deletion
  };
  ...
  return (
    <div className={styles.sectionContainer}>
      ...
      <Dialog
        ...
        title={t('accountBasics.deleteAccountDialogTitle')}
        size="small"
        messageType="warning"
        actions={
          <>
      ...
      {/* Reauthenticate Dialog for Deletion */}
      <Dialog
      ...
      >
        <div className={styles.reauthDialogContent}>
          <p>
            {authProvider === 'google.com'
