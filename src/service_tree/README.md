...
Goal: Refactor the platform's logic into a centralized "Action Catalog" (src/service_tree) where every business operation is defined as a discrete, auditable, and AI-callable action.

Current Context:

Target Directory: src/service_tree/actions/
...
TypeScript
// src/service_tree/actions/types.ts
import { z } from "zod";
...
TypeScript
// src/service_tree/actions/hook.ts
...
TypeScript
// src/service_tree/actions/registry.ts
...
File: src/service_tree/actions/catalog/calendar/createShift.ts
...
export const createShiftAction: ActionDefinition<typeof InputSchema, void> = {
  ...
  fileLocation: "src/service_tree/actions/catalog/calendar/createShift.ts",
