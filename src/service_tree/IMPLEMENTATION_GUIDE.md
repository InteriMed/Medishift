...
```typescript
import { useSmartAuth, hasPermission } from '@/service_tree/services/auth';
...
```typescript
import { useFeatureFlag } from '@/service_tree/services/flags';
...
```typescript
import { broadcastNotification } from '@/service_tree/services/notifications';
...
```typescript
import { setTelemetryUser, captureError } from '@/service_tree/services/telemetry';
