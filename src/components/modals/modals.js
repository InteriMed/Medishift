...
const Modal = ({
  ...
  return createPortal(
    ...
    >
      ...
      <div
        className={cn(
          "bg-white w-full rounded-2xl overflow-hidden flex flex-col relative transform transition-all duration-300 shadow-2xl border border-slate-200 modal-root",
          sizeClasses[size],
          accentClasses[messageType] || accentClasses.default,
