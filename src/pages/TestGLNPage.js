...
const TestGLNPage = () => {
    ...
    return (
        <div className="p-10 max-w-4xl mx-auto">
            <h1 className="text-3xl font-bold mb-6">GLN Extraction Test</h1>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md space-y-4">
                ...
                <div>
                    <label className="block text-sm font-medium mb-1">GLN (13 digits)</label>
                    <input
                        type="text"
                        value={gln}
                        onChange={(e) => setGln(e.target.value)}
                        className="w-full p-2 border rounded"
                        placeholder="e.g. 7601001419988"
                    />
                </div>
                ...
                >
                    {loading ? 'Testing...' : 'Test GLN Extraction'}
                </button>
