...
const FAQPage = () => {
  ...
  return (
    <div className="faq-page bg-premium-hero">
      <Helmet>
      ...
      {/* Hero Section */}
      <section className="relative pt-12 pb-20 lg:pt-16 lg:pb-28 overflow-hidden bg-premium-hero flex items-center justify-center">
