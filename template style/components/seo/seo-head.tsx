...
export function SEOHead({
  title = 'Clipizy - AI-Powered Long-Form Media Content Creation',
  ...
  return (
    <Head>
      ...
      <meta name="author" content="Clipizy Team" />
      <meta
        name="robots"
      ...
      <meta property="og:site_name" content="Clipizy" />
      ...
      />
      <meta name="apple-mobile-web-app-title" content="Clipizy" />
