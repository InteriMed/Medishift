...
import { useRepositories } from '@/hooks/compliance/use-compliance-data';
        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Generate compliance reports and transparency labels for auditors
                    </p>
                </div>
            ...
            <Tabs defaultValue="article50" className="space-y-4">
                ...
                <TabsContent value="article50" className="space-y-4">
                    <Card>
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <div>
                                    <CardTitle>Article 50 Compliance Report</CardTitle>
                                    <CardDescription>
                ...
                <TabsContent value="transparency" className="space-y-4">
                    <Card>
                        <CardHeader>
                            <CardTitle>Transparency Text Generator</CardTitle>
                            <CardDescription>
