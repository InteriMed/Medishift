...
export const TIME_SLOT_HEIGHT = 50; // Height of a 1-hour slot in pixels
export const FIRST_HOUR = 0; // Starting hour (0-23)
export const LAST_HOUR = 23; // Ending hour (0-23)
export const HOURS_PER_DAY = LAST_HOUR - FIRST_HOUR + 1; 